...
table f09_pop_urban_iso(t_all,iso,pop_gdp_scen09) urban Population (mio. capita per yr)
$ondelim
$include "./modules/09_drivers/input/f09_urban_iso.csv"
$offdelim;

table f09_pop_grid(t_all,j,pop_gdp_scen09) Population (mio. capita per yr)
$ondelim
$include "./modules/09_drivers/input/f09_pop_grid.cs3"
$offdelim;

table f09_pop_urban_grid(t_all,j,pop_gdp_scen09, urb) Population (mio. capita per yr)
$ondelim
