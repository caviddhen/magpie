...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov18_res_biomass_ag_cell(t,j,kcr,attributes,"marginal") = v18_res_biomass_ag_cell.m(j,kcr,attributes);
 ...
 oq18_prod_res_ag_cell(t,j,kcr,attributes,"marginal")    = q18_prod_res_ag_cell.m(j,kcr,attributes);
 oq18_prod_res_ag_reg(t,i,kcr,attributes,"marginal")     = q18_prod_res_ag_reg.m(i,kcr,attributes);
 oq18_prod_res_bg_cell(t,i,kcr,dm_nr,"marginal")         = q18_prod_res_bg_cell.m(i,kcr,dm_nr);
 ...
 oq18_cell_field_constraint(t,j,kres,"marginal")         = q18_cell_field_constraint.m(j,kres);
 ...
 ov18_res_biomass_ag_cell(t,j,kcr,attributes,"level")    = v18_res_biomass_ag_cell.l(j,kcr,attributes);
 ...
 oq18_prod_res_ag_cell(t,j,kcr,attributes,"level")       = q18_prod_res_ag_cell.l(j,kcr,attributes);
 oq18_prod_res_ag_reg(t,i,kcr,attributes,"level")        = q18_prod_res_ag_reg.l(i,kcr,attributes);
 oq18_prod_res_bg_cell(t,i,kcr,dm_nr,"level")            = q18_prod_res_bg_cell.l(i,kcr,dm_nr);
 ...
 oq18_cell_field_constraint(t,j,kres,"level")            = q18_cell_field_constraint.l(j,kres);
 ...
 ov18_res_biomass_ag_cell(t,j,kcr,attributes,"upper")    = v18_res_biomass_ag_cell.up(j,kcr,attributes);
 ...
 oq18_prod_res_ag_cell(t,j,kcr,attributes,"upper")       = q18_prod_res_ag_cell.up(j,kcr,attributes);
 oq18_prod_res_ag_reg(t,i,kcr,attributes,"upper")        = q18_prod_res_ag_reg.up(i,kcr,attributes);
 oq18_prod_res_bg_cell(t,i,kcr,dm_nr,"upper")            = q18_prod_res_bg_cell.up(i,kcr,dm_nr);
 ...
 oq18_cell_field_constraint(t,j,kres,"upper")            = q18_cell_field_constraint.up(j,kres);
 ...
 ov18_res_biomass_ag_cell(t,j,kcr,attributes,"lower")    = v18_res_biomass_ag_cell.lo(j,kcr,attributes);
 ...
 oq18_prod_res_ag_cell(t,j,kcr,attributes,"lower")       = q18_prod_res_ag_cell.lo(j,kcr,attributes);
 oq18_prod_res_ag_reg(t,i,kcr,attributes,"lower")        = q18_prod_res_ag_reg.lo(i,kcr,attributes);
 oq18_prod_res_bg_cell(t,i,kcr,dm_nr,"lower")            = q18_prod_res_bg_cell.lo(i,kcr,dm_nr);
 ...
 oq18_cell_field_constraint(t,j,kres,"lower")            = q18_cell_field_constraint.lo(j,kres);
