...
table i38_labour_impact(t_all,j,factor) LAMACLIMA yield reduction
$ondelim
...
$if "%c38_labour_switch%" == "normal" i38_labour_impact(t_all,j) = f14_labour_impact(t_all,j,"normal");
