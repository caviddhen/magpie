...
$Ifi "%factor_costs%" == "mixed_labour_nov20" $include "./modules/38_factor_costs/mixed_labour_nov20/realization.gms"
$Ifi "%factor_costs%" == "mixed_labour_okt20" $include "./modules/38_factor_costs/mixed_labour_okt20/realization.gms"
