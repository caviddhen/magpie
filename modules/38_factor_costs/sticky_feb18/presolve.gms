...
f38_capital_cost_share(t)=0.46;
else
f38_capital_cost_share(t)=0;
);
$else
f38_capital_cost_share(t)=0.46;
$endif
...
i38_capital_need(i,kcr,"mobile") = f38_fac_req_per_ton(kcr) * f38_capital_cost_share(t) / pm_interest(t,i) * (1-s38_immobile);
i38_capital_need(i,kcr,"immobile") = f38_fac_req_per_ton(kcr)*f38_capital_cost_share(t) / pm_interest(t,i) * s38_immobile;

if (ord(t) = 1,

i38_variable_costs(i2,kcr) = f38_fac_req_per_ton(kcr) * (1-f38_capital_cost_share(t)) * (1-s38_mi_start);
