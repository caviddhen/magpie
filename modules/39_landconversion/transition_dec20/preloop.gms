...
i39_cost_transition("crop", "urban") = 1000;
i39_cost_transition("past", "urban") = 2500;
i39_cost_transition("forestry", "urban") = 10000;
i39_cost_transition(natveg_from39,"urban") = 10000;
