...
i40_urban_shr(t_all, j, "urban") = sum(cell(i,j), im_pop_urban(t_all, i)) / sum(cell(i,j), im_pop(t_all,i));
i40_urban_shr(t_all, j, "rural") = sum(cell(i,j), im_pop(t_all, i) -  im_pop_urban(t_all, i)) / sum(cell(i,j), im_pop(t_all,i)) ;
