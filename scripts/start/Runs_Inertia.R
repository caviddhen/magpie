...
#        if(s == "variable"){
#        cfg$title<-paste0("Follow_up_s_",ssp,"_rcp_",rc,"_",c,"_",s,"_shock_",year[y],"_")
#      }else{
#        cfg$title<-paste0("Follow_up_s_",ssp,"_rcp_",rc,"_",c,"_",s,"_")
#      }
 cfg$title<-paste0("Runs_Inertia_BestSet_",ssp,"_rcp_",rc,"_",c,"_",s,"_")

        cfg$force_download <- TRUE
###    CALIBRATION FILE DEPENDING ON CAPITAL SHARE)

#         if(s=="constant"){
#           calib_tgz<-"calibration_H12_sticky_feb18_constant__09Nov20.tgz"
#         }else if (s=="variable"){
#           calib_tgz<-"calibration_H12_sticky_feb18_variable__09Nov20.tgz"
#         }
